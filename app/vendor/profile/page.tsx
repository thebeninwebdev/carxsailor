...
export default async function Page(){
  ...
  return <ActionForm kind="updateProfile" className="card grid max-w-2xl gap-4 p-7" pendingLabel="Saving profile..."><h2 className="text-xl font-bold">Public vendor profile</h2>
    <label><span className="label">Business name / Display name</span><input className="input" name="displayName" required minLength={2} maxLength={100} defaultValue={vendor?.displayName}/></label>
